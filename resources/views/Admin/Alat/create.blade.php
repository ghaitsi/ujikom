...
<head>
    ...
    <title>LibTrack - Tambah Buku Baru</title>
...
<body class="font-sans antialiased">
    ...
    <div class="app-container" id="appContainer">
        ...
        <main class="main-content" id="mainContent">
            <!-- Glass Header -->
            <header class="header">
                <h1 class="header-title animate__animated animate__fadeIn">Tambah Buku Baru</h1>
                        ...
                        <form action="{{ route('admin.alat.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Masukkan kota tempat penerbitan"
                                ...
                                <div class="form-text">
                                    <i class="fas fa-lightbulb"></i>
                                    Kota atau tempat penerbit buku
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kondisi" 
                                    ...
                                    <option value="Baik" {{ old('kondisi') == 'Baik' ? 'selected' : '' }}>Baik (Seperti Baru)</option>
                                    <option value="Rusak Ringan" {{ old('kondisi') == 'Rusak Ringan' ? 'selected' : '' }}>Rusak Ringan (Lecet kecil)</option>
                                    <option value="Rusak Berat" {{ old('kondisi') == 'Rusak Berat' ? 'selected' : '' }}>Rusak Berat (Halaman rusak)</option>
                                    <option value="Perlu Perbaikan" {{ old('kondisi') == 'Perlu Perbaikan' ? 'selected' : '' }}>Perlu Perbaikan (Jilid lepas)</option>
                                </select>
                                @error('kondisi')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" 
                                    ...
                                    <option value="tersedia" {{ old('status') == 'tersedia' ? 'selected' : '' }}>Tersedia untuk Dipinjam</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-preview" id="filePreview">
                                    <img id="previewImage" src="" alt="Preview Cover Buku">
                                    <button type="button" 
                                ...
                                <div class="form-text">
                                    <i class="fas fa-lightbulb"></i>
                                    Upload gambar cover buku (opsional)
                                </div>
                            </div>
    ...
    <script>
        ...
        if (kategoriSelect) {
            kategoriSelect.addEventListener('change', function() {
                console.log('Selected Genre ID:', this.value);
            });
        }
    </script>
</body>
